...
/*
AuthorizationApiService Get tokens
 ...
 * @param grantType Determines the required type of authorization:password - authorize a user; client_credentials - authorize a client;refresh_token - refresh a user&#39;s access_token.
 * @param clientId Client identifier
 * @param clientSecret Client secret
 * @param optional nil or *AuthorizationApiGetTokenOpts - Optional Parameters:
     * @param "RefreshToken" (optional.String) -  Refresh token. Required for grant_type&#x3D;refresh_token only.
     * @param "Username" (optional.String) -  User identifier. Required for grant_type&#x3D;password only.
     * @param "Password" (optional.String) -  User password. Required for grant_type&#x3D;password only.

@return AccessToken
*/

type AuthorizationApiGetTokenOpts struct {
	RefreshToken optional.String
	Username     optional.String
	Password     optional.String
}

func (a *AuthorizationApiService) GetToken(ctx context.Context, grantType string, clientId string, clientSecret string, localVarOptionals *AuthorizationApiGetTokenOpts) (AccessToken, *http.Response, error) {
	var (
...
/*
AuthorizationApiService Revoke a token
 ...
 * @param optional nil or *AuthorizationApiRevokeTokenOpts - Optional Parameters:
     * @param "TokenTypeHint" (optional.String) -  A hint about the type of the token submitted for revocation


*/

type AuthorizationApiRevokeTokenOpts struct {
	TokenTypeHint optional.String
}

func (a *AuthorizationApiService) RevokeToken(ctx context.Context, token string, localVarOptionals *AuthorizationApiRevokeTokenOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/oauth/revoke"
