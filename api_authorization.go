...
func (a *AuthorizationApiService) GetToken(ctx context.Context, grantType string, clientId string, clientSecret string, localVarOptionals *GetTokenOpts) (AccessToken, *http.Response, error) {
	var (
 ...
 * @param optional nil or *RevokeTokenOpts - Optional Parameters:
...
func (a *AuthorizationApiService) RevokeToken(ctx context.Context, token string, localVarOptionals *RevokeTokenOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
