 ...
 * @param optional nil or *BanksApiGetAndSearchAllBanksOpts - Optional Parameters:
...
type BanksApiGetAndSearchAllBanksOpts struct {
...
func (a *BanksApiService) GetAndSearchAllBanks(ctx context.Context, localVarOptionals *BanksApiGetAndSearchAllBanksOpts) (PageableBankList, *http.Response, error) {
	var (
