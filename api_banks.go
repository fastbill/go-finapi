 ...
 * @param optional nil or *GetAndSearchAllBanksOpts - Optional Parameters:
     ...
     * @param "IsSupported" (optional.Bool) -  If specified, then only supported (in case of &#39;true&#39; value) or unsupported (in case of &#39;false&#39; value) banks will be regarded.
     * @param "PinsAreVolatile" (optional.Bool) -  If specified, then only those banks will be regarded that have the given value (true or false) for their &#39;pinsAreVolatile&#39; field.
     * @param "SupportedDataSources" (optional.Interface of []string) -  Comma-separated list of data sources. Possible values: WEB_SCRAPER,FINTS_SERVER. If this parameter is specified, then only those banks will be regarded in the search that support ALL of the given data sources. Note that this does NOT imply that those data sources must be the only data sources that are supported by a bank.
