 ...
 * @param optional nil or *EditCategoryOpts - Optional Parameters:
...
func (a *CategoriesApiService) EditCategory(ctx context.Context, id int64, localVarOptionals *EditCategoryOpts) (Category, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetAndSearchAllCategoriesOpts - Optional Parameters:
...
type GetAndSearchAllCategoriesOpts struct {
...
func (a *CategoriesApiService) GetAndSearchAllCategories(ctx context.Context, localVarOptionals *GetAndSearchAllCategoriesOpts) (PageableCategoryList, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetCashFlowsOpts - Optional Parameters:
...
func (a *CategoriesApiService) GetCashFlows(ctx context.Context, localVarOptionals *GetCashFlowsOpts) (CashFlowList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TrainCategorizationOpts - Optional Parameters:
     * @param "Body" (optional.Interface of TrainCategorizationData) -  Categorization sample


*/

type TrainCategorizationOpts struct {
	Body optional.Interface
}

func (a *CategoriesApiService) TrainCategorization(ctx context.Context, localVarOptionals *TrainCategorizationOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
