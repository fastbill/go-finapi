 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LabelsApiGetAndSearchAllLabelsOpts - Optional Parameters:
...
type LabelsApiGetAndSearchAllLabelsOpts struct {
...
func (a *LabelsApiService) GetAndSearchAllLabels(ctx context.Context, localVarOptionals *LabelsApiGetAndSearchAllLabelsOpts) (PageableLabelList, *http.Response, error) {
	var (
