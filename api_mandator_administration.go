 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MandatorAdministrationApiGetIbanRuleListOpts - Optional Parameters:
...
type MandatorAdministrationApiGetIbanRuleListOpts struct {
	Page    optional.Int32
	PerPage optional.Int32
}

func (a *MandatorAdministrationApiService) GetIbanRuleList(ctx context.Context, localVarOptionals *MandatorAdministrationApiGetIbanRuleListOpts) (PageableIbanRuleList, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MandatorAdministrationApiGetKeywordRuleListOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  Result page that you want to retrieve
     * @param "PerPage" (optional.Int32) -  Maximum number of records per page. By default it&#39;s 20. Can be at most 500. NOTE: Due to its validation and visualization, the swagger frontend might show very low performance, or even crashes, when a service responds with a lot of data. It is recommended to use a HTTP client like Postman or DHC instead of our swagger frontend for service calls with large page sizes.
...
type MandatorAdministrationApiGetKeywordRuleListOpts struct {
	Page    optional.Int32
	PerPage optional.Int32
}

func (a *MandatorAdministrationApiService) GetKeywordRuleList(ctx context.Context, localVarOptionals *MandatorAdministrationApiGetKeywordRuleListOpts) (PageableKeywordRuleList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MandatorAdministrationApiGetUserListOpts - Optional Parameters:
...
type MandatorAdministrationApiGetUserListOpts struct {
...
func (a *MandatorAdministrationApiService) GetUserList(ctx context.Context, localVarOptionals *MandatorAdministrationApiGetUserListOpts) (PageableUserInfoList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
