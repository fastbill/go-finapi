 ...
 * @param optional nil or *SecuritiesApiGetAndSearchAllSecuritiesOpts - Optional Parameters:
...
type SecuritiesApiGetAndSearchAllSecuritiesOpts struct {
...
func (a *SecuritiesApiService) GetAndSearchAllSecurities(ctx context.Context, localVarOptionals *SecuritiesApiGetAndSearchAllSecuritiesOpts) (PageableSecurityList, *http.Response, error) {
	var (
