 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TPPCertificatesApiGetAllCertificatesOpts - Optional Parameters:
...
type TPPCertificatesApiGetAllCertificatesOpts struct {
	Page    optional.Int32
	PerPage optional.Int32
}

func (a *TPPCertificatesApiService) GetAllCertificates(ctx context.Context, localVarOptionals *TPPCertificatesApiGetAllCertificatesOpts) (PageableTppCertificateList, *http.Response, error) {
	var (
