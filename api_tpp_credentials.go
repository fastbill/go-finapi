 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TPPCredentialsApiGetAllTppCredentialsOpts - Optional Parameters:
...
type TPPCredentialsApiGetAllTppCredentialsOpts struct {
	Search  optional.String
	Page    optional.Int32
	PerPage optional.Int32
}

func (a *TPPCredentialsApiService) GetAllTppCredentials(ctx context.Context, localVarOptionals *TPPCredentialsApiGetAllTppCredentialsOpts) (PageableTppCredentialResources, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TPPCredentialsApiGetAndSearchTppAuthenticationGroupsOpts - Optional Parameters:
...
type TPPCredentialsApiGetAndSearchTppAuthenticationGroupsOpts struct {
...
func (a *TPPCredentialsApiService) GetAndSearchTppAuthenticationGroups(ctx context.Context, localVarOptionals *TPPCredentialsApiGetAndSearchTppAuthenticationGroupsOpts) (PageableTppAuthenticationGroupResources, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
