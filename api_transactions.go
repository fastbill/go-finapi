 ...
 * @param optional nil or *TransactionsApiDeleteAllTransactionsOpts - Optional Parameters:
...
type TransactionsApiDeleteAllTransactionsOpts struct {
	MaxDeletionDate  optional.String
	SafeMode         optional.Bool
	RememberDeletion optional.Bool
}

func (a *TransactionsApiService) DeleteAllTransactions(ctx context.Context, localVarOptionals *TransactionsApiDeleteAllTransactionsOpts) (IdentifierList, *http.Response, error) {
	var (
 ...
 * @param optional nil or *TransactionsApiGetAndSearchAllTransactionsOpts - Optional Parameters:
...
type TransactionsApiGetAndSearchAllTransactionsOpts struct {
...
func (a *TransactionsApiService) GetAndSearchAllTransactions(ctx context.Context, view string, localVarOptionals *TransactionsApiGetAndSearchAllTransactionsOpts) (PageableTransactionList, *http.Response, error) {
	var (
