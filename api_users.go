 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExecutePasswordChangeOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ExecutePasswordChangeParams) -


*/

type ExecutePasswordChangeOpts struct {
	Body optional.Interface
}

func (a *UsersApiService) ExecutePasswordChange(ctx context.Context, localVarOptionals *ExecutePasswordChangeOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RequestPasswordChangeOpts - Optional Parameters:
     * @param "Body" (optional.Interface of RequestPasswordChangeParams) -

@return PasswordChangingResource
*/

type RequestPasswordChangeOpts struct {
	Body optional.Interface
}

func (a *UsersApiService) RequestPasswordChange(ctx context.Context, localVarOptionals *RequestPasswordChangeOpts) (PasswordChangingResource, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
