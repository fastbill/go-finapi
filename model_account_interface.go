...
func (o *AccountInterface) GetPaymentCapabilities() AccountInterfacePaymentCapabilities {
	if o == nil  {
		var ret AccountInterfacePaymentCapabilities
		return ret
	}
...
func (o AccountInterface) MarshalJSON() ([]byte, error) {
...
type NullableAccountInterface struct {
	value *AccountInterface
	isSet bool
}

func (v NullableAccountInterface) Get() *AccountInterface {
	return v.value
}

func (v *NullableAccountInterface) Set(val *AccountInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountInterface(val *AccountInterface) *NullableAccountInterface {
	return &NullableAccountInterface{value: val, isSet: true}
}

func (v NullableAccountInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
