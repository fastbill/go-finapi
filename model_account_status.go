...
const (
	ACCOUNTSTATUS_UPDATED AccountStatus = "UPDATED"
	ACCOUNTSTATUS_UPDATED_FIXED AccountStatus = "UPDATED_FIXED"
	ACCOUNTSTATUS_DOWNLOAD_IN_PROGRESS AccountStatus = "DOWNLOAD_IN_PROGRESS"
	ACCOUNTSTATUS_DOWNLOAD_FAILED AccountStatus = "DOWNLOAD_FAILED"
	ACCOUNTSTATUS_DEPRECATED AccountStatus = "DEPRECATED"
)
...
func (v *AccountStatus) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []AccountStatus{ "UPDATED", "UPDATED_FIXED", "DOWNLOAD_IN_PROGRESS", "DOWNLOAD_FAILED", "DEPRECATED",   } {
