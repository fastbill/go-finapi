...
const (
	...
	ACCOUNTTYPE_CREDIT_CARD AccountType = "CreditCard"
	ACCOUNTTYPE_SECURITY AccountType = "Security"
	ACCOUNTTYPE_LOAN AccountType = "Loan"
	ACCOUNTTYPE_POCKET AccountType = "Pocket"
...
func (v *AccountType) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []AccountType{ "Checking", "Savings", "CreditCard", "Security", "Loan", "Pocket", "Membership", "Bausparen",   } {
