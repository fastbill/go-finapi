...
func (o BadCredentialsError) MarshalJSON() ([]byte, error) {
...
type NullableBadCredentialsError struct {
	value *BadCredentialsError
	isSet bool
}

func (v NullableBadCredentialsError) Get() *BadCredentialsError {
	return v.value
}

func (v *NullableBadCredentialsError) Set(val *BadCredentialsError) {
	v.value = val
	v.isSet = true
}

func (v NullableBadCredentialsError) IsSet() bool {
	return v.isSet
}

func (v *NullableBadCredentialsError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBadCredentialsError(val *BadCredentialsError) *NullableBadCredentialsError {
	return &NullableBadCredentialsError{value: val, isSet: true}
}

func (v NullableBadCredentialsError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBadCredentialsError) UnmarshalJSON(src []byte) error {
	v.isSet = true
