...
func (o BankConnectionList) MarshalJSON() ([]byte, error) {
...
type NullableBankConnectionList struct {
	value *BankConnectionList
	isSet bool
}

func (v NullableBankConnectionList) Get() *BankConnectionList {
	return v.value
}

func (v *NullableBankConnectionList) Set(val *BankConnectionList) {
	v.value = val
	v.isSet = true
}

func (v NullableBankConnectionList) IsSet() bool {
	return v.isSet
}

func (v *NullableBankConnectionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankConnectionList(val *BankConnectionList) *NullableBankConnectionList {
	return &NullableBankConnectionList{value: val, isSet: true}
}

func (v NullableBankConnectionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankConnectionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
