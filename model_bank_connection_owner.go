...
type BankConnectionOwner struct {
	...
	// House number
	HouseNumber NullableString `json:"houseNumber"`
}

// NewBankConnectionOwner instantiates a new BankConnectionOwner object
...
// NewBankConnectionOwnerWithDefaults instantiates a new BankConnectionOwner object
...
func (o *BankConnectionOwner) GetHouseNumber() string {
	if o == nil || o.HouseNumber.Get() == nil {
		var ret string
		return ret
	}
...
func (o BankConnectionOwner) MarshalJSON() ([]byte, error) {
...
type NullableBankConnectionOwner struct {
	value *BankConnectionOwner
	isSet bool
}

func (v NullableBankConnectionOwner) Get() *BankConnectionOwner {
	return v.value
}

func (v *NullableBankConnectionOwner) Set(val *BankConnectionOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableBankConnectionOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableBankConnectionOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankConnectionOwner(val *BankConnectionOwner) *NullableBankConnectionOwner {
	return &NullableBankConnectionOwner{value: val, isSet: true}
}

func (v NullableBankConnectionOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankConnectionOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
