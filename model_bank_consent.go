...
func (o BankConsent) MarshalJSON() ([]byte, error) {
...
type NullableBankConsent struct {
	value *BankConsent
	isSet bool
}

func (v NullableBankConsent) Get() *BankConsent {
	return v.value
}

func (v *NullableBankConsent) Set(val *BankConsent) {
	v.value = val
	v.isSet = true
}

func (v NullableBankConsent) IsSet() bool {
	return v.isSet
}

func (v *NullableBankConsent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankConsent(val *BankConsent) *NullableBankConsent {
	return &NullableBankConsent{value: val, isSet: true}
}

func (v NullableBankConsent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankConsent) UnmarshalJSON(src []byte) error {
	v.isSet = true
