...
func (o BankGroup) MarshalJSON() ([]byte, error) {
...
type NullableBankGroup struct {
	value *BankGroup
	isSet bool
}

func (v NullableBankGroup) Get() *BankGroup {
	return v.value
}

func (v *NullableBankGroup) Set(val *BankGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableBankGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableBankGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankGroup(val *BankGroup) *NullableBankGroup {
	return &NullableBankGroup{value: val, isSet: true}
}

func (v NullableBankGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
