...
// GetIsVolatile returns the IsVolatile field value
...
// GetIsVolatileOk returns a tuple with the IsVolatile field value
// and a boolean to check if the value has been set.
...
// SetIsVolatile sets field value
func (o *BankInterfaceLoginField) SetIsVolatile(v bool) {
	o.IsVolatile = v
}

func (o BankInterfaceLoginField) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["isVolatile"] = o.IsVolatile
	}
	return json.Marshal(toSerialize)
}

type NullableBankInterfaceLoginField struct {
	value *BankInterfaceLoginField
	isSet bool
}

func (v NullableBankInterfaceLoginField) Get() *BankInterfaceLoginField {
	return v.value
}

func (v *NullableBankInterfaceLoginField) Set(val *BankInterfaceLoginField) {
	v.value = val
	v.isSet = true
}

func (v NullableBankInterfaceLoginField) IsSet() bool {
	return v.isSet
}

func (v *NullableBankInterfaceLoginField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankInterfaceLoginField(val *BankInterfaceLoginField) *NullableBankInterfaceLoginField {
	return &NullableBankInterfaceLoginField{value: val, isSet: true}
}

func (v NullableBankInterfaceLoginField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankInterfaceLoginField) UnmarshalJSON(src []byte) error {
	v.isSet = true
