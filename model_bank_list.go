...
func (o BankList) MarshalJSON() ([]byte, error) {
...
type NullableBankList struct {
	value *BankList
	isSet bool
}

func (v NullableBankList) Get() *BankList {
	return v.value
}

func (v *NullableBankList) Set(val *BankList) {
	v.value = val
	v.isSet = true
}

func (v NullableBankList) IsSet() bool {
	return v.isSet
}

func (v *NullableBankList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankList(val *BankList) *NullableBankList {
	return &NullableBankList{value: val, isSet: true}
}

func (v NullableBankList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankList) UnmarshalJSON(src []byte) error {
	v.isSet = true
