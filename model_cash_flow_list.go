...
// GetTotalIncome returns the TotalIncome field value
...
// GetTotalIncomeOk returns a tuple with the TotalIncome field value
// and a boolean to check if the value has been set.
...
// SetTotalIncome sets field value
func (o *CashFlowList) SetTotalIncome(v float64) {
	o.TotalIncome = v
}

// GetTotalSpending returns the TotalSpending field value
func (o *CashFlowList) GetTotalSpending() float64 {
	...
	return o.TotalSpending
}

// GetTotalSpendingOk returns a tuple with the TotalSpending field value
// and a boolean to check if the value has been set.
func (o *CashFlowList) GetTotalSpendingOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.TotalSpending, true
}

// SetTotalSpending sets field value
...
func (o CashFlowList) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["cashFlows"] = o.CashFlows
	}
	if true {
		toSerialize["totalIncome"] = o.TotalIncome
	}
	if true {
		toSerialize["totalSpending"] = o.TotalSpending
	}
	if true {
...
type NullableCashFlowList struct {
	value *CashFlowList
	isSet bool
}

func (v NullableCashFlowList) Get() *CashFlowList {
	return v.value
}

func (v *NullableCashFlowList) Set(val *CashFlowList) {
	v.value = val
	v.isSet = true
}

func (v NullableCashFlowList) IsSet() bool {
	return v.isSet
}

func (v *NullableCashFlowList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCashFlowList(val *CashFlowList) *NullableCashFlowList {
	return &NullableCashFlowList{value: val, isSet: true}
}

func (v NullableCashFlowList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCashFlowList) UnmarshalJSON(src []byte) error {
	v.isSet = true
