...
type CategorizationCheckResult struct {
	...
	// <strong>Type:</strong> Category<br/> A category. The determined transaction category for the given transactionId. This can be null, if the categorization algorithm fails to find a matching rule.
...
func NewCategorizationCheckResult(transactionId string, category NullableCategory, ) *CategorizationCheckResult {
	this := CategorizationCheckResult{}
...
func (o CategorizationCheckResult) MarshalJSON() ([]byte, error) {
...
type NullableCategorizationCheckResult struct {
	value *CategorizationCheckResult
	isSet bool
}

func (v NullableCategorizationCheckResult) Get() *CategorizationCheckResult {
	return v.value
}

func (v *NullableCategorizationCheckResult) Set(val *CategorizationCheckResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCategorizationCheckResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCategorizationCheckResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategorizationCheckResult(val *CategorizationCheckResult) *NullableCategorizationCheckResult {
	return &NullableCategorizationCheckResult{value: val, isSet: true}
}

func (v NullableCategorizationCheckResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategorizationCheckResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
