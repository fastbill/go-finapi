...
func NewChangeClientCredentialsParams(clientId string, oldClientSecret string, newClientSecret string, ) *ChangeClientCredentialsParams {
	this := ChangeClientCredentialsParams{}
...
// GetOldClientSecret returns the OldClientSecret field value
...
// GetOldClientSecretOk returns a tuple with the OldClientSecret field value
// and a boolean to check if the value has been set.
...
// SetOldClientSecret sets field value
func (o *ChangeClientCredentialsParams) SetOldClientSecret(v string) {
	o.OldClientSecret = v
}

// GetNewClientSecret returns the NewClientSecret field value
...
// GetNewClientSecretOk returns a tuple with the NewClientSecret field value
// and a boolean to check if the value has been set.
...
// SetNewClientSecret sets field value
func (o *ChangeClientCredentialsParams) SetNewClientSecret(v string) {
	o.NewClientSecret = v
}

func (o ChangeClientCredentialsParams) MarshalJSON() ([]byte, error) {
...
type NullableChangeClientCredentialsParams struct {
	value *ChangeClientCredentialsParams
	isSet bool
}

func (v NullableChangeClientCredentialsParams) Get() *ChangeClientCredentialsParams {
	return v.value
}

func (v *NullableChangeClientCredentialsParams) Set(val *ChangeClientCredentialsParams) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeClientCredentialsParams) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeClientCredentialsParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeClientCredentialsParams(val *ChangeClientCredentialsParams) *NullableChangeClientCredentialsParams {
	return &NullableChangeClientCredentialsParams{value: val, isSet: true}
}

func (v NullableChangeClientCredentialsParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeClientCredentialsParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
