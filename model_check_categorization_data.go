...
func (o *CheckCategorizationData) GetTransactionData() []CheckCategorizationTransactionData {
	if o == nil  {
		var ret []CheckCategorizationTransactionData
		return ret
	}
...
func (o CheckCategorizationData) MarshalJSON() ([]byte, error) {
...
type NullableCheckCategorizationData struct {
	value *CheckCategorizationData
	isSet bool
}

func (v NullableCheckCategorizationData) Get() *CheckCategorizationData {
	return v.value
}

func (v *NullableCheckCategorizationData) Set(val *CheckCategorizationData) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCategorizationData) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCategorizationData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCategorizationData(val *CheckCategorizationData) *NullableCheckCategorizationData {
	return &NullableCheckCategorizationData{value: val, isSet: true}
}

func (v NullableCheckCategorizationData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCategorizationData) UnmarshalJSON(src []byte) error {
	v.isSet = true
