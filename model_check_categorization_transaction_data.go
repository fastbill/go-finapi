...
func NewCheckCategorizationTransactionData(transactionId string, accountTypeId int64, amount float64, ) *CheckCategorizationTransactionData {
	this := CheckCategorizationTransactionData{}
...
// GetTypeCodeZka returns the TypeCodeZka field value if set, zero value otherwise.
func (o *CheckCategorizationTransactionData) GetTypeCodeZka() string {
	if o == nil || o.TypeCodeZka == nil {
		var ret string
		return ret
	}
	return *o.TypeCodeZka
}

// GetTypeCodeZkaOk returns a tuple with the TypeCodeZka field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CheckCategorizationTransactionData) GetTypeCodeZkaOk() (*string, bool) {
	if o == nil || o.TypeCodeZka == nil {
		return nil, false
	}
	return o.TypeCodeZka, true
}
...
// SetTypeCodeZka gets a reference to the given string and assigns it to the TypeCodeZka field.
func (o *CheckCategorizationTransactionData) SetTypeCodeZka(v string) {
	o.TypeCodeZka = &v
}

func (o CheckCategorizationTransactionData) MarshalJSON() ([]byte, error) {
	...
	if o.TypeCodeZka != nil {
		toSerialize["typeCodeZka"] = o.TypeCodeZka
	}
	return json.Marshal(toSerialize)
}

type NullableCheckCategorizationTransactionData struct {
	value *CheckCategorizationTransactionData
	isSet bool
}

func (v NullableCheckCategorizationTransactionData) Get() *CheckCategorizationTransactionData {
	return v.value
}

func (v *NullableCheckCategorizationTransactionData) Set(val *CheckCategorizationTransactionData) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCategorizationTransactionData) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCategorizationTransactionData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCategorizationTransactionData(val *CheckCategorizationTransactionData) *NullableCheckCategorizationTransactionData {
	return &NullableCheckCategorizationTransactionData{value: val, isSet: true}
}

func (v NullableCheckCategorizationTransactionData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCategorizationTransactionData) UnmarshalJSON(src []byte) error {
	v.isSet = true
