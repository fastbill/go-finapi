...
type DailyBalanceList struct {
	...
	LatestCommonBalanceTimestamp NullableString `json:"latestCommonBalanceTimestamp"`
	...
	// <strong>Type:</strong> Paging<br/> Information for pagination
...
// GetLatestCommonBalanceTimestamp returns the LatestCommonBalanceTimestamp field value
// If the value is explicit nil, the zero value for string will be returned
func (o *DailyBalanceList) GetLatestCommonBalanceTimestamp() string {
	if o == nil || o.LatestCommonBalanceTimestamp.Get() == nil {
		var ret string
		return ret
	}

	return *o.LatestCommonBalanceTimestamp.Get()
}

// GetLatestCommonBalanceTimestampOk returns a tuple with the LatestCommonBalanceTimestamp field value
...
func (o *DailyBalanceList) GetLatestCommonBalanceTimestampOk() (*string, bool) {
	...
	return o.LatestCommonBalanceTimestamp.Get(), o.LatestCommonBalanceTimestamp.IsSet()
}

// SetLatestCommonBalanceTimestamp sets field value
func (o *DailyBalanceList) SetLatestCommonBalanceTimestamp(v string) {
	o.LatestCommonBalanceTimestamp.Set(&v)
}

// GetDailyBalances returns the DailyBalances field value
func (o *DailyBalanceList) GetDailyBalances() []DailyBalance {
	if o == nil  {
		var ret []DailyBalance
		return ret
	}

	return o.DailyBalances
}

// GetDailyBalancesOk returns a tuple with the DailyBalances field value
// and a boolean to check if the value has been set.
func (o *DailyBalanceList) GetDailyBalancesOk() (*[]DailyBalance, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.DailyBalances, true
}

// SetDailyBalances sets field value
...
func (o DailyBalanceList) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["latestCommonBalanceTimestamp"] = o.LatestCommonBalanceTimestamp.Get()
	}
	if true {
		toSerialize["dailyBalances"] = o.DailyBalances
	}
	if true {
...
type NullableDailyBalanceList struct {
	value *DailyBalanceList
	isSet bool
}

func (v NullableDailyBalanceList) Get() *DailyBalanceList {
	return v.value
}

func (v *NullableDailyBalanceList) Set(val *DailyBalanceList) {
	v.value = val
	v.isSet = true
}

func (v NullableDailyBalanceList) IsSet() bool {
	return v.isSet
}

func (v *NullableDailyBalanceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDailyBalanceList(val *DailyBalanceList) *NullableDailyBalanceList {
	return &NullableDailyBalanceList{value: val, isSet: true}
}

func (v NullableDailyBalanceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDailyBalanceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
