...
type DeleteConsent struct {
	...
	Local DeleteConsentResult `json:"local"`
	...
	Remote DeleteConsentResult `json:"remote"`
}
...
func (o DeleteConsent) MarshalJSON() ([]byte, error) {
...
type NullableDeleteConsent struct {
	value *DeleteConsent
	isSet bool
}

func (v NullableDeleteConsent) Get() *DeleteConsent {
	return v.value
}

func (v *NullableDeleteConsent) Set(val *DeleteConsent) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteConsent) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteConsent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteConsent(val *DeleteConsent) *NullableDeleteConsent {
	return &NullableDeleteConsent{value: val, isSet: true}
}

func (v NullableDeleteConsent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteConsent) UnmarshalJSON(src []byte) error {
	v.isSet = true
