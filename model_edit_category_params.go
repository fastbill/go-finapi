...
func (o EditCategoryParams) MarshalJSON() ([]byte, error) {
...
type NullableEditCategoryParams struct {
	value *EditCategoryParams
	isSet bool
}

func (v NullableEditCategoryParams) Get() *EditCategoryParams {
	return v.value
}

func (v *NullableEditCategoryParams) Set(val *EditCategoryParams) {
	v.value = val
	v.isSet = true
}

func (v NullableEditCategoryParams) IsSet() bool {
	return v.isSet
}

func (v *NullableEditCategoryParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditCategoryParams(val *EditCategoryParams) *NullableEditCategoryParams {
	return &NullableEditCategoryParams{value: val, isSet: true}
}

func (v NullableEditCategoryParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditCategoryParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
