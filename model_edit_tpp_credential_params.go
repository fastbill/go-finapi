...
// GetTppAuthenticationGroupId returns the TppAuthenticationGroupId field value if set, zero value otherwise.
func (o *EditTppCredentialParams) GetTppAuthenticationGroupId() int64 {
	if o == nil || o.TppAuthenticationGroupId == nil {
		var ret int64
		return ret
	}
	return *o.TppAuthenticationGroupId
}

// GetTppAuthenticationGroupIdOk returns a tuple with the TppAuthenticationGroupId field value if set, nil otherwise
...
// SetTppAuthenticationGroupId gets a reference to the given int64 and assigns it to the TppAuthenticationGroupId field.
func (o *EditTppCredentialParams) SetTppAuthenticationGroupId(v int64) {
	o.TppAuthenticationGroupId = &v
}
...
// GetTppClientId returns the TppClientId field value if set, zero value otherwise.
func (o *EditTppCredentialParams) GetTppClientId() string {
	if o == nil || o.TppClientId == nil {
		var ret string
		return ret
	}
	return *o.TppClientId
}

// GetTppClientIdOk returns a tuple with the TppClientId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTppClientId gets a reference to the given string and assigns it to the TppClientId field.
func (o *EditTppCredentialParams) SetTppClientId(v string) {
	o.TppClientId = &v
}

// GetTppClientSecret returns the TppClientSecret field value if set, zero value otherwise.
func (o *EditTppCredentialParams) GetTppClientSecret() string {
	if o == nil || o.TppClientSecret == nil {
		var ret string
		return ret
	}
	return *o.TppClientSecret
}

// GetTppClientSecretOk returns a tuple with the TppClientSecret field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTppClientSecret gets a reference to the given string and assigns it to the TppClientSecret field.
func (o *EditTppCredentialParams) SetTppClientSecret(v string) {
	o.TppClientSecret = &v
}

// GetTppApiKey returns the TppApiKey field value if set, zero value otherwise.
...
// GetTppApiKeyOk returns a tuple with the TppApiKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTppApiKey gets a reference to the given string and assigns it to the TppApiKey field.
...
func (o EditTppCredentialParams) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.TppAuthenticationGroupId != nil {
		toSerialize["tppAuthenticationGroupId"] = o.TppAuthenticationGroupId
	}
	if o.Label != nil {
		toSerialize["label"] = o.Label
	}
	if o.TppClientId != nil {
		toSerialize["tppClientId"] = o.TppClientId
	}
	if o.TppClientSecret != nil {
		toSerialize["tppClientSecret"] = o.TppClientSecret
	}
	if o.TppApiKey != nil {
		toSerialize["tppApiKey"] = o.TppApiKey
	}
	if o.TppName != nil {
		toSerialize["tppName"] = o.TppName
	}
...
type NullableEditTppCredentialParams struct {
	value *EditTppCredentialParams
	isSet bool
}

func (v NullableEditTppCredentialParams) Get() *EditTppCredentialParams {
	return v.value
}

func (v *NullableEditTppCredentialParams) Set(val *EditTppCredentialParams) {
	v.value = val
	v.isSet = true
}

func (v NullableEditTppCredentialParams) IsSet() bool {
	return v.isSet
}

func (v *NullableEditTppCredentialParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditTppCredentialParams(val *EditTppCredentialParams) *NullableEditTppCredentialParams {
	return &NullableEditTppCredentialParams{value: val, isSet: true}
}

func (v NullableEditTppCredentialParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditTppCredentialParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
