...
type ErrorDetails struct {
	...
	// <strong>Type:</strong> MultiStepAuthenticationChallenge<br/> This field is set when a multi-step authentication is required, i.e. when you need to repeat the original service call and provide additional data. The field contains information about what additional data is required.
	MultiStepAuthentication NullableMultiStepAuthenticationChallenge `json:"multiStepAuthentication"`
}
...
func NewErrorDetails(message NullableString, code ErrorCode, type_ ErrorType, multiStepAuthentication NullableMultiStepAuthenticationChallenge, ) *ErrorDetails {
	...
	this.Code = code
	this.Type = type_
	this.MultiStepAuthentication = multiStepAuthentication
	return &this
}
...
// GetMultiStepAuthentication returns the MultiStepAuthentication field value
// If the value is explicit nil, the zero value for MultiStepAuthenticationChallenge will be returned
func (o *ErrorDetails) GetMultiStepAuthentication() MultiStepAuthenticationChallenge {
	if o == nil || o.MultiStepAuthentication.Get() == nil {
		var ret MultiStepAuthenticationChallenge
		return ret
	}

	return *o.MultiStepAuthentication.Get()
}

// GetMultiStepAuthenticationOk returns a tuple with the MultiStepAuthentication field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ErrorDetails) GetMultiStepAuthenticationOk() (*MultiStepAuthenticationChallenge, bool) {
	...
	return o.MultiStepAuthentication.Get(), o.MultiStepAuthentication.IsSet()
}

// SetMultiStepAuthentication sets field value
func (o *ErrorDetails) SetMultiStepAuthentication(v MultiStepAuthenticationChallenge) {
	o.MultiStepAuthentication.Set(&v)
}
...
func (o ErrorDetails) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["multiStepAuthentication"] = o.MultiStepAuthentication.Get()
	}
