...
func NewExecutePasswordChangeParams(userId string, password string, passwordChangeToken string, ) *ExecutePasswordChangeParams {
	this := ExecutePasswordChangeParams{}
	this.UserId = userId
...
// GetPasswordChangeToken returns the PasswordChangeToken field value
func (o *ExecutePasswordChangeParams) GetPasswordChangeToken() string {
	...
	return o.PasswordChangeToken
}

// GetPasswordChangeTokenOk returns a tuple with the PasswordChangeToken field value
// and a boolean to check if the value has been set.
func (o *ExecutePasswordChangeParams) GetPasswordChangeTokenOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.PasswordChangeToken, true
}

// SetPasswordChangeToken sets field value
func (o *ExecutePasswordChangeParams) SetPasswordChangeToken(v string) {
	o.PasswordChangeToken = v
}

func (o ExecutePasswordChangeParams) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["passwordChangeToken"] = o.PasswordChangeToken
	}
	return json.Marshal(toSerialize)
}

type NullableExecutePasswordChangeParams struct {
	value *ExecutePasswordChangeParams
	isSet bool
}

func (v NullableExecutePasswordChangeParams) Get() *ExecutePasswordChangeParams {
	return v.value
}

func (v *NullableExecutePasswordChangeParams) Set(val *ExecutePasswordChangeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableExecutePasswordChangeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableExecutePasswordChangeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecutePasswordChangeParams(val *ExecutePasswordChangeParams) *NullableExecutePasswordChangeParams {
	return &NullableExecutePasswordChangeParams{value: val, isSet: true}
}

func (v NullableExecutePasswordChangeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecutePasswordChangeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
