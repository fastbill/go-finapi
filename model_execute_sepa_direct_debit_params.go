...
func NewExecuteSepaDirectDebitParams(accountId int64, ) *ExecuteSepaDirectDebitParams {
	this := ExecuteSepaDirectDebitParams{}
...
func (o ExecuteSepaDirectDebitParams) MarshalJSON() ([]byte, error) {
...
type NullableExecuteSepaDirectDebitParams struct {
	value *ExecuteSepaDirectDebitParams
	isSet bool
}

func (v NullableExecuteSepaDirectDebitParams) Get() *ExecuteSepaDirectDebitParams {
	return v.value
}

func (v *NullableExecuteSepaDirectDebitParams) Set(val *ExecuteSepaDirectDebitParams) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteSepaDirectDebitParams) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteSepaDirectDebitParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteSepaDirectDebitParams(val *ExecuteSepaDirectDebitParams) *NullableExecuteSepaDirectDebitParams {
	return &NullableExecuteSepaDirectDebitParams{value: val, isSet: true}
}

func (v NullableExecuteSepaDirectDebitParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteSepaDirectDebitParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
