...
func NewExecuteSepaMoneyTransferParams(accountId int64, ) *ExecuteSepaMoneyTransferParams {
	this := ExecuteSepaMoneyTransferParams{}
...
// GetBankingTan returns the BankingTan field value if set, zero value otherwise.
func (o *ExecuteSepaMoneyTransferParams) GetBankingTan() string {
	if o == nil || o.BankingTan == nil {
		var ret string
		return ret
	}
	return *o.BankingTan
...
// GetBankingTanOk returns a tuple with the BankingTan field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExecuteSepaMoneyTransferParams) GetBankingTanOk() (*string, bool) {
	if o == nil || o.BankingTan == nil {
		return nil, false
	}
	return o.BankingTan, true
}
...
// SetBankingTan gets a reference to the given string and assigns it to the BankingTan field.
func (o *ExecuteSepaMoneyTransferParams) SetBankingTan(v string) {
	o.BankingTan = &v
}

func (o ExecuteSepaMoneyTransferParams) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["accountId"] = o.AccountId
	}
	if o.BankingTan != nil {
		toSerialize["bankingTan"] = o.BankingTan
	}
	return json.Marshal(toSerialize)
}

type NullableExecuteSepaMoneyTransferParams struct {
	value *ExecuteSepaMoneyTransferParams
	isSet bool
}

func (v NullableExecuteSepaMoneyTransferParams) Get() *ExecuteSepaMoneyTransferParams {
	return v.value
}

func (v *NullableExecuteSepaMoneyTransferParams) Set(val *ExecuteSepaMoneyTransferParams) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteSepaMoneyTransferParams) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteSepaMoneyTransferParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteSepaMoneyTransferParams(val *ExecuteSepaMoneyTransferParams) *NullableExecuteSepaMoneyTransferParams {
	return &NullableExecuteSepaMoneyTransferParams{value: val, isSet: true}
}

func (v NullableExecuteSepaMoneyTransferParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteSepaMoneyTransferParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
