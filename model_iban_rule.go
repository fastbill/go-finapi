...
func (o IbanRule) MarshalJSON() ([]byte, error) {
...
type NullableIbanRule struct {
	value *IbanRule
	isSet bool
}

func (v NullableIbanRule) Get() *IbanRule {
	return v.value
}

func (v *NullableIbanRule) Set(val *IbanRule) {
	v.value = val
	v.isSet = true
}

func (v NullableIbanRule) IsSet() bool {
	return v.isSet
}

func (v *NullableIbanRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIbanRule(val *IbanRule) *NullableIbanRule {
	return &NullableIbanRule{value: val, isSet: true}
}

func (v NullableIbanRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIbanRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
