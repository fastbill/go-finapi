...
func (o IbanRuleParams) MarshalJSON() ([]byte, error) {
...
type NullableIbanRuleParams struct {
	value *IbanRuleParams
	isSet bool
}

func (v NullableIbanRuleParams) Get() *IbanRuleParams {
	return v.value
}

func (v *NullableIbanRuleParams) Set(val *IbanRuleParams) {
	v.value = val
	v.isSet = true
}

func (v NullableIbanRuleParams) IsSet() bool {
	return v.isSet
}

func (v *NullableIbanRuleParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIbanRuleParams(val *IbanRuleParams) *NullableIbanRuleParams {
	return &NullableIbanRuleParams{value: val, isSet: true}
}

func (v NullableIbanRuleParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIbanRuleParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
