...
func (o IdentifierList) MarshalJSON() ([]byte, error) {
...
type NullableIdentifierList struct {
	value *IdentifierList
	isSet bool
}

func (v NullableIdentifierList) Get() *IdentifierList {
	return v.value
}

func (v *NullableIdentifierList) Set(val *IdentifierList) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentifierList) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentifierList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentifierList(val *IdentifierList) *NullableIdentifierList {
	return &NullableIdentifierList{value: val, isSet: true}
}

func (v NullableIdentifierList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentifierList) UnmarshalJSON(src []byte) error {
	v.isSet = true
