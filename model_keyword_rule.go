...
type KeywordRule struct {
	...
	AllKeywordsMustMatch bool `json:"allKeywordsMustMatch"`
}
...
// GetAllKeywordsMustMatch returns the AllKeywordsMustMatch field value
...
// GetAllKeywordsMustMatchOk returns a tuple with the AllKeywordsMustMatch field value
// and a boolean to check if the value has been set.
...
// SetAllKeywordsMustMatch sets field value
func (o *KeywordRule) SetAllKeywordsMustMatch(v bool) {
	o.AllKeywordsMustMatch = v
}

func (o KeywordRule) MarshalJSON() ([]byte, error) {
...
type NullableKeywordRule struct {
	value *KeywordRule
	isSet bool
}

func (v NullableKeywordRule) Get() *KeywordRule {
	return v.value
}

func (v *NullableKeywordRule) Set(val *KeywordRule) {
	v.value = val
	v.isSet = true
}

func (v NullableKeywordRule) IsSet() bool {
	return v.isSet
}

func (v *NullableKeywordRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeywordRule(val *KeywordRule) *NullableKeywordRule {
	return &NullableKeywordRule{value: val, isSet: true}
}

func (v NullableKeywordRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeywordRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
