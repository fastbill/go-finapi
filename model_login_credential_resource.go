...
func (o LoginCredentialResource) MarshalJSON() ([]byte, error) {
...
type NullableLoginCredentialResource struct {
	value *LoginCredentialResource
	isSet bool
}

func (v NullableLoginCredentialResource) Get() *LoginCredentialResource {
	return v.value
}

func (v *NullableLoginCredentialResource) Set(val *LoginCredentialResource) {
	v.value = val
	v.isSet = true
}

func (v NullableLoginCredentialResource) IsSet() bool {
	return v.isSet
}

func (v *NullableLoginCredentialResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoginCredentialResource(val *LoginCredentialResource) *NullableLoginCredentialResource {
	return &NullableLoginCredentialResource{value: val, isSet: true}
}

func (v NullableLoginCredentialResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoginCredentialResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
