...
func NewMockBankConnectionUpdate(bankConnectionId int64, ) *MockBankConnectionUpdate {
	this := MockBankConnectionUpdate{}
	this.BankConnectionId = bankConnectionId
	var simulateBankLoginError bool = false
...
// GetSimulateBankLoginError returns the SimulateBankLoginError field value if set, zero value otherwise.
func (o *MockBankConnectionUpdate) GetSimulateBankLoginError() bool {
	if o == nil || o.SimulateBankLoginError == nil {
		var ret bool
		return ret
	}
	return *o.SimulateBankLoginError
}

// GetSimulateBankLoginErrorOk returns a tuple with the SimulateBankLoginError field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MockBankConnectionUpdate) GetSimulateBankLoginErrorOk() (*bool, bool) {
	if o == nil || o.SimulateBankLoginError == nil {
		return nil, false
	}
	return o.SimulateBankLoginError, true
}
...
// SetSimulateBankLoginError gets a reference to the given bool and assigns it to the SimulateBankLoginError field.
func (o *MockBankConnectionUpdate) SetSimulateBankLoginError(v bool) {
	o.SimulateBankLoginError = &v
}

// GetMockAccountsData returns the MockAccountsData field value if set, zero value otherwise.
func (o *MockBankConnectionUpdate) GetMockAccountsData() []MockAccountData {
	if o == nil || o.MockAccountsData == nil {
		var ret []MockAccountData
		return ret
	}
	return *o.MockAccountsData
}

// GetMockAccountsDataOk returns a tuple with the MockAccountsData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MockBankConnectionUpdate) GetMockAccountsDataOk() (*[]MockAccountData, bool) {
	if o == nil || o.MockAccountsData == nil {
		return nil, false
	}
	return o.MockAccountsData, true
}
...
// SetMockAccountsData gets a reference to the given []MockAccountData and assigns it to the MockAccountsData field.
func (o *MockBankConnectionUpdate) SetMockAccountsData(v []MockAccountData) {
	o.MockAccountsData = &v
}

func (o MockBankConnectionUpdate) MarshalJSON() ([]byte, error) {
	...
	if o.SimulateBankLoginError != nil {
		toSerialize["simulateBankLoginError"] = o.SimulateBankLoginError
	}
	if o.MockAccountsData != nil {
		toSerialize["mockAccountsData"] = o.MockAccountsData
	}
	return json.Marshal(toSerialize)
}

type NullableMockBankConnectionUpdate struct {
	value *MockBankConnectionUpdate
	isSet bool
}

func (v NullableMockBankConnectionUpdate) Get() *MockBankConnectionUpdate {
	return v.value
}

func (v *NullableMockBankConnectionUpdate) Set(val *MockBankConnectionUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableMockBankConnectionUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableMockBankConnectionUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMockBankConnectionUpdate(val *MockBankConnectionUpdate) *NullableMockBankConnectionUpdate {
	return &NullableMockBankConnectionUpdate{value: val, isSet: true}
}

func (v NullableMockBankConnectionUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMockBankConnectionUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
