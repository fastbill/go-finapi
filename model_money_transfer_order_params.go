...
func (o MoneyTransferOrderParams) MarshalJSON() ([]byte, error) {
...
type NullableMoneyTransferOrderParams struct {
	value *MoneyTransferOrderParams
	isSet bool
}

func (v NullableMoneyTransferOrderParams) Get() *MoneyTransferOrderParams {
	return v.value
}

func (v *NullableMoneyTransferOrderParams) Set(val *MoneyTransferOrderParams) {
	v.value = val
	v.isSet = true
}

func (v NullableMoneyTransferOrderParams) IsSet() bool {
	return v.isSet
}

func (v *NullableMoneyTransferOrderParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoneyTransferOrderParams(val *MoneyTransferOrderParams) *NullableMoneyTransferOrderParams {
	return &NullableMoneyTransferOrderParams{value: val, isSet: true}
}

func (v NullableMoneyTransferOrderParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoneyTransferOrderParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
