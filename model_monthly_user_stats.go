...
// GetMinBankConnectionCount returns the MinBankConnectionCount field value
func (o *MonthlyUserStats) GetMinBankConnectionCount() int32 {
	...
	return o.MinBankConnectionCount
}

// GetMinBankConnectionCountOk returns a tuple with the MinBankConnectionCount field value
// and a boolean to check if the value has been set.
func (o *MonthlyUserStats) GetMinBankConnectionCountOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.MinBankConnectionCount, true
}

// SetMinBankConnectionCount sets field value
func (o *MonthlyUserStats) SetMinBankConnectionCount(v int32) {
	o.MinBankConnectionCount = v
}

// GetMaxBankConnectionCount returns the MaxBankConnectionCount field value
func (o *MonthlyUserStats) GetMaxBankConnectionCount() int32 {
	...
	return o.MaxBankConnectionCount
}

// GetMaxBankConnectionCountOk returns a tuple with the MaxBankConnectionCount field value
// and a boolean to check if the value has been set.
func (o *MonthlyUserStats) GetMaxBankConnectionCountOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.MaxBankConnectionCount, true
}

// SetMaxBankConnectionCount sets field value
func (o *MonthlyUserStats) SetMaxBankConnectionCount(v int32) {
	o.MaxBankConnectionCount = v
}

func (o MonthlyUserStats) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["month"] = o.Month
	}
	if true {
		toSerialize["minBankConnectionCount"] = o.MinBankConnectionCount
	}
	if true {
		toSerialize["maxBankConnectionCount"] = o.MaxBankConnectionCount
	}
	return json.Marshal(toSerialize)
}

type NullableMonthlyUserStats struct {
	value *MonthlyUserStats
	isSet bool
}

func (v NullableMonthlyUserStats) Get() *MonthlyUserStats {
	return v.value
}

func (v *NullableMonthlyUserStats) Set(val *MonthlyUserStats) {
	v.value = val
	v.isSet = true
}

func (v NullableMonthlyUserStats) IsSet() bool {
	return v.isSet
}

func (v *NullableMonthlyUserStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonthlyUserStats(val *MonthlyUserStats) *NullableMonthlyUserStats {
	return &NullableMonthlyUserStats{value: val, isSet: true}
}

func (v NullableMonthlyUserStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonthlyUserStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
