...
func NewMultiStepAuthenticationCallback(hash string, ) *MultiStepAuthenticationCallback {
	this := MultiStepAuthenticationCallback{}
	this.Hash = hash
	return &this
}
...
// GetRedirectCallback returns the RedirectCallback field value if set, zero value otherwise.
func (o *MultiStepAuthenticationCallback) GetRedirectCallback() string {
	if o == nil || o.RedirectCallback == nil {
		var ret string
		return ret
	}
	return *o.RedirectCallback
}

// GetRedirectCallbackOk returns a tuple with the RedirectCallback field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MultiStepAuthenticationCallback) GetRedirectCallbackOk() (*string, bool) {
	if o == nil || o.RedirectCallback == nil {
		return nil, false
	}
	return o.RedirectCallback, true
}
...
// SetRedirectCallback gets a reference to the given string and assigns it to the RedirectCallback field.
func (o *MultiStepAuthenticationCallback) SetRedirectCallback(v string) {
	o.RedirectCallback = &v
}

// GetDecoupledCallback returns the DecoupledCallback field value if set, zero value otherwise.
func (o *MultiStepAuthenticationCallback) GetDecoupledCallback() bool {
	if o == nil || o.DecoupledCallback == nil {
		var ret bool
		return ret
	}
	return *o.DecoupledCallback
}

// GetDecoupledCallbackOk returns a tuple with the DecoupledCallback field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MultiStepAuthenticationCallback) GetDecoupledCallbackOk() (*bool, bool) {
	if o == nil || o.DecoupledCallback == nil {
		return nil, false
	}
	return o.DecoupledCallback, true
}
...
// SetDecoupledCallback gets a reference to the given bool and assigns it to the DecoupledCallback field.
func (o *MultiStepAuthenticationCallback) SetDecoupledCallback(v bool) {
	o.DecoupledCallback = &v
}

func (o MultiStepAuthenticationCallback) MarshalJSON() ([]byte, error) {
	...
	if o.RedirectCallback != nil {
		toSerialize["redirectCallback"] = o.RedirectCallback
	}
	if o.DecoupledCallback != nil {
		toSerialize["decoupledCallback"] = o.DecoupledCallback
	}
	return json.Marshal(toSerialize)
}

type NullableMultiStepAuthenticationCallback struct {
	value *MultiStepAuthenticationCallback
	isSet bool
}

func (v NullableMultiStepAuthenticationCallback) Get() *MultiStepAuthenticationCallback {
	return v.value
}

func (v *NullableMultiStepAuthenticationCallback) Set(val *MultiStepAuthenticationCallback) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiStepAuthenticationCallback) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiStepAuthenticationCallback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiStepAuthenticationCallback(val *MultiStepAuthenticationCallback) *NullableMultiStepAuthenticationCallback {
	return &NullableMultiStepAuthenticationCallback{value: val, isSet: true}
}

func (v NullableMultiStepAuthenticationCallback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiStepAuthenticationCallback) UnmarshalJSON(src []byte) error {
	v.isSet = true
