...
type NotificationRule struct {
	...
	CallbackHandle NullableString `json:"callbackHandle"`
...
// GetCallbackHandle returns the CallbackHandle field value
// If the value is explicit nil, the zero value for string will be returned
func (o *NotificationRule) GetCallbackHandle() string {
	if o == nil || o.CallbackHandle.Get() == nil {
		var ret string
		return ret
	}

	return *o.CallbackHandle.Get()
}

// GetCallbackHandleOk returns a tuple with the CallbackHandle field value
// and a boolean to check if the value has been set.
...
func (o *NotificationRule) GetCallbackHandleOk() (*string, bool) {
	...
	return o.CallbackHandle.Get(), o.CallbackHandle.IsSet()
}

// SetCallbackHandle sets field value
func (o *NotificationRule) SetCallbackHandle(v string) {
	o.CallbackHandle.Set(&v)
}

// GetIncludeDetails returns the IncludeDetails field value
...
// GetIncludeDetailsOk returns a tuple with the IncludeDetails field value
// and a boolean to check if the value has been set.
...
// SetIncludeDetails sets field value
...
func (o NotificationRule) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["callbackHandle"] = o.CallbackHandle.Get()
	}
	if true {
