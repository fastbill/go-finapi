...
func (o NotificationRuleList) MarshalJSON() ([]byte, error) {
...
type NullableNotificationRuleList struct {
	value *NotificationRuleList
	isSet bool
}

func (v NullableNotificationRuleList) Get() *NotificationRuleList {
	return v.value
}

func (v *NullableNotificationRuleList) Set(val *NotificationRuleList) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationRuleList) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationRuleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationRuleList(val *NotificationRuleList) *NullableNotificationRuleList {
	return &NullableNotificationRuleList{value: val, isSet: true}
}

func (v NullableNotificationRuleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationRuleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
