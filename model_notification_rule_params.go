...
// GetCallbackHandle returns the CallbackHandle field value if set, zero value otherwise.
func (o *NotificationRuleParams) GetCallbackHandle() string {
	if o == nil || o.CallbackHandle == nil {
		var ret string
		return ret
	}
	return *o.CallbackHandle
}

// GetCallbackHandleOk returns a tuple with the CallbackHandle field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NotificationRuleParams) GetCallbackHandleOk() (*string, bool) {
	if o == nil || o.CallbackHandle == nil {
		return nil, false
	}
	return o.CallbackHandle, true
}
...
// SetCallbackHandle gets a reference to the given string and assigns it to the CallbackHandle field.
...
func (o NotificationRuleParams) MarshalJSON() ([]byte, error) {
	...
	if o.CallbackHandle != nil {
		toSerialize["callbackHandle"] = o.CallbackHandle
	}
...
type NullableNotificationRuleParams struct {
	value *NotificationRuleParams
	isSet bool
}

func (v NullableNotificationRuleParams) Get() *NotificationRuleParams {
	return v.value
}

func (v *NullableNotificationRuleParams) Set(val *NotificationRuleParams) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationRuleParams) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationRuleParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationRuleParams(val *NotificationRuleParams) *NullableNotificationRuleParams {
	return &NullableNotificationRuleParams{value: val, isSet: true}
}

func (v NullableNotificationRuleParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationRuleParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
