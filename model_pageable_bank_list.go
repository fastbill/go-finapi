...
func (o PageableBankList) MarshalJSON() ([]byte, error) {
...
type NullablePageableBankList struct {
	value *PageableBankList
	isSet bool
}

func (v NullablePageableBankList) Get() *PageableBankList {
	return v.value
}

func (v *NullablePageableBankList) Set(val *PageableBankList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableBankList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableBankList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableBankList(val *PageableBankList) *NullablePageableBankList {
	return &NullablePageableBankList{value: val, isSet: true}
}

func (v NullablePageableBankList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableBankList) UnmarshalJSON(src []byte) error {
	v.isSet = true
