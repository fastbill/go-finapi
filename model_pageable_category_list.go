...
func (o PageableCategoryList) MarshalJSON() ([]byte, error) {
...
type NullablePageableCategoryList struct {
	value *PageableCategoryList
	isSet bool
}

func (v NullablePageableCategoryList) Get() *PageableCategoryList {
	return v.value
}

func (v *NullablePageableCategoryList) Set(val *PageableCategoryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableCategoryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableCategoryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableCategoryList(val *PageableCategoryList) *NullablePageableCategoryList {
	return &NullablePageableCategoryList{value: val, isSet: true}
}

func (v NullablePageableCategoryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableCategoryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
