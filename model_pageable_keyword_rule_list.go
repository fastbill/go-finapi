...
// GetKeywordRules returns the KeywordRules field value
func (o *PageableKeywordRuleList) GetKeywordRules() []KeywordRule {
	...
	return o.KeywordRules
}

// GetKeywordRulesOk returns a tuple with the KeywordRules field value
// and a boolean to check if the value has been set.
func (o *PageableKeywordRuleList) GetKeywordRulesOk() (*[]KeywordRule, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.KeywordRules, true
}

// SetKeywordRules sets field value
...
func (o PageableKeywordRuleList) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["keywordRules"] = o.KeywordRules
	}
	if true {
...
type NullablePageableKeywordRuleList struct {
	value *PageableKeywordRuleList
	isSet bool
}

func (v NullablePageableKeywordRuleList) Get() *PageableKeywordRuleList {
	return v.value
}

func (v *NullablePageableKeywordRuleList) Set(val *PageableKeywordRuleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableKeywordRuleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableKeywordRuleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableKeywordRuleList(val *PageableKeywordRuleList) *NullablePageableKeywordRuleList {
	return &NullablePageableKeywordRuleList{value: val, isSet: true}
}

func (v NullablePageableKeywordRuleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableKeywordRuleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
