...
func (o PageableLabelList) MarshalJSON() ([]byte, error) {
...
type NullablePageableLabelList struct {
	value *PageableLabelList
	isSet bool
}

func (v NullablePageableLabelList) Get() *PageableLabelList {
	return v.value
}

func (v *NullablePageableLabelList) Set(val *PageableLabelList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableLabelList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableLabelList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableLabelList(val *PageableLabelList) *NullablePageableLabelList {
	return &NullablePageableLabelList{value: val, isSet: true}
}

func (v NullablePageableLabelList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableLabelList) UnmarshalJSON(src []byte) error {
	v.isSet = true
