...
func (o PageablePaymentResources) MarshalJSON() ([]byte, error) {
...
type NullablePageablePaymentResources struct {
	value *PageablePaymentResources
	isSet bool
}

func (v NullablePageablePaymentResources) Get() *PageablePaymentResources {
	return v.value
}

func (v *NullablePageablePaymentResources) Set(val *PageablePaymentResources) {
	v.value = val
	v.isSet = true
}

func (v NullablePageablePaymentResources) IsSet() bool {
	return v.isSet
}

func (v *NullablePageablePaymentResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageablePaymentResources(val *PageablePaymentResources) *NullablePageablePaymentResources {
	return &NullablePageablePaymentResources{value: val, isSet: true}
}

func (v NullablePageablePaymentResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageablePaymentResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
