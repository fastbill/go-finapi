...
func (o PageableSecurityList) MarshalJSON() ([]byte, error) {
...
type NullablePageableSecurityList struct {
	value *PageableSecurityList
	isSet bool
}

func (v NullablePageableSecurityList) Get() *PageableSecurityList {
	return v.value
}

func (v *NullablePageableSecurityList) Set(val *PageableSecurityList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableSecurityList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableSecurityList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableSecurityList(val *PageableSecurityList) *NullablePageableSecurityList {
	return &NullablePageableSecurityList{value: val, isSet: true}
}

func (v NullablePageableSecurityList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableSecurityList) UnmarshalJSON(src []byte) error {
	v.isSet = true
