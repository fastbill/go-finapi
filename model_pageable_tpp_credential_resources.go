...
func NewPageableTppCredentialResources(paging Paging, tppCredentials []TppCredentials, ) *PageableTppCredentialResources {
	this := PageableTppCredentialResources{}
	this.Paging = paging
...
// GetTppCredentials returns the TppCredentials field value
func (o *PageableTppCredentialResources) GetTppCredentials() []TppCredentials {
	if o == nil  {
		var ret []TppCredentials
		return ret
	}

	return o.TppCredentials
}

// GetTppCredentialsOk returns a tuple with the TppCredentials field value
// and a boolean to check if the value has been set.
func (o *PageableTppCredentialResources) GetTppCredentialsOk() (*[]TppCredentials, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.TppCredentials, true
}

// SetTppCredentials sets field value
func (o *PageableTppCredentialResources) SetTppCredentials(v []TppCredentials) {
	o.TppCredentials = v
}

func (o PageableTppCredentialResources) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["paging"] = o.Paging
	}
	if true {
		toSerialize["tppCredentials"] = o.TppCredentials
	}
	return json.Marshal(toSerialize)
}

type NullablePageableTppCredentialResources struct {
	value *PageableTppCredentialResources
	isSet bool
}

func (v NullablePageableTppCredentialResources) Get() *PageableTppCredentialResources {
	return v.value
}

func (v *NullablePageableTppCredentialResources) Set(val *PageableTppCredentialResources) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableTppCredentialResources) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableTppCredentialResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableTppCredentialResources(val *PageableTppCredentialResources) *NullablePageableTppCredentialResources {
	return &NullablePageableTppCredentialResources{value: val, isSet: true}
}

func (v NullablePageableTppCredentialResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableTppCredentialResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
