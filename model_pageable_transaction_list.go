...
func (o PageableTransactionList) MarshalJSON() ([]byte, error) {
...
type NullablePageableTransactionList struct {
	value *PageableTransactionList
	isSet bool
}

func (v NullablePageableTransactionList) Get() *PageableTransactionList {
	return v.value
}

func (v *NullablePageableTransactionList) Set(val *PageableTransactionList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableTransactionList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableTransactionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableTransactionList(val *PageableTransactionList) *NullablePageableTransactionList {
	return &NullablePageableTransactionList{value: val, isSet: true}
}

func (v NullablePageableTransactionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableTransactionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
