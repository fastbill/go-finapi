...
func (o PageableUserInfoList) MarshalJSON() ([]byte, error) {
...
type NullablePageableUserInfoList struct {
	value *PageableUserInfoList
	isSet bool
}

func (v NullablePageableUserInfoList) Get() *PageableUserInfoList {
	return v.value
}

func (v *NullablePageableUserInfoList) Set(val *PageableUserInfoList) {
	v.value = val
	v.isSet = true
}

func (v NullablePageableUserInfoList) IsSet() bool {
	return v.isSet
}

func (v *NullablePageableUserInfoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageableUserInfoList(val *PageableUserInfoList) *NullablePageableUserInfoList {
	return &NullablePageableUserInfoList{value: val, isSet: true}
}

func (v NullablePageableUserInfoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageableUserInfoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
