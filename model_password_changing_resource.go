...
func (o PasswordChangingResource) MarshalJSON() ([]byte, error) {
...
type NullablePasswordChangingResource struct {
	value *PasswordChangingResource
	isSet bool
}

func (v NullablePasswordChangingResource) Get() *PasswordChangingResource {
	return v.value
}

func (v *NullablePasswordChangingResource) Set(val *PasswordChangingResource) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordChangingResource) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordChangingResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordChangingResource(val *PasswordChangingResource) *NullablePasswordChangingResource {
	return &NullablePasswordChangingResource{value: val, isSet: true}
}

func (v NullablePasswordChangingResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordChangingResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
