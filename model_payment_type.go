...
// List of PaymentType
const (
	PAYMENTTYPE_MONEY_TRANSFER PaymentType = "MONEY_TRANSFER"
	PAYMENTTYPE_DIRECT_DEBIT PaymentType = "DIRECT_DEBIT"
)
...
func (v *PaymentType) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []PaymentType{ "MONEY_TRANSFER", "DIRECT_DEBIT",   } {
