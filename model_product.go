...
const (
	...
	PRODUCT_DATA_INTELLIGENCE Product = "DATA_INTELLIGENCE"
	PRODUCT_WEB_FORM Product = "WEB_FORM"
	PRODUCT_GIRO_IDENT Product = "GIRO_IDENT"
)
...
func (v *Product) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []Product{ "ACCESS", "DATA_INTELLIGENCE", "WEB_FORM", "GIRO_IDENT",   } {
