...
func (o RemoveInterfaceParams) MarshalJSON() ([]byte, error) {
...
type NullableRemoveInterfaceParams struct {
	value *RemoveInterfaceParams
	isSet bool
}

func (v NullableRemoveInterfaceParams) Get() *RemoveInterfaceParams {
	return v.value
}

func (v *NullableRemoveInterfaceParams) Set(val *RemoveInterfaceParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoveInterfaceParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoveInterfaceParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoveInterfaceParams(val *RemoveInterfaceParams) *NullableRemoveInterfaceParams {
	return &NullableRemoveInterfaceParams{value: val, isSet: true}
}

func (v NullableRemoveInterfaceParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoveInterfaceParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
