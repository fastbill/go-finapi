...
func NewRequestSepaDirectDebitParams(accountId int64, directDebitType DirectDebitType, sequenceType DirectDebitSequenceType, executionDate string, directDebits []SingleDirectDebitData, ) *RequestSepaDirectDebitParams {
	this := RequestSepaDirectDebitParams{}
...
func (o RequestSepaDirectDebitParams) MarshalJSON() ([]byte, error) {
...
type NullableRequestSepaDirectDebitParams struct {
	value *RequestSepaDirectDebitParams
	isSet bool
}

func (v NullableRequestSepaDirectDebitParams) Get() *RequestSepaDirectDebitParams {
	return v.value
}

func (v *NullableRequestSepaDirectDebitParams) Set(val *RequestSepaDirectDebitParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSepaDirectDebitParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSepaDirectDebitParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSepaDirectDebitParams(val *RequestSepaDirectDebitParams) *NullableRequestSepaDirectDebitParams {
	return &NullableRequestSepaDirectDebitParams{value: val, isSet: true}
}

func (v NullableRequestSepaDirectDebitParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestSepaDirectDebitParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
