...
func (o SecurityList) MarshalJSON() ([]byte, error) {
...
type NullableSecurityList struct {
	value *SecurityList
	isSet bool
}

func (v NullableSecurityList) Get() *SecurityList {
	return v.value
}

func (v *NullableSecurityList) Set(val *SecurityList) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityList) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityList(val *SecurityList) *NullableSecurityList {
	return &NullableSecurityList{value: val, isSet: true}
}

func (v NullableSecurityList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityList) UnmarshalJSON(src []byte) error {
	v.isSet = true
