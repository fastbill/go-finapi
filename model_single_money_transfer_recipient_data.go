...
func NewSingleMoneyTransferRecipientData(amount float64, ) *SingleMoneyTransferRecipientData {
	this := SingleMoneyTransferRecipientData{}
	this.Amount = amount
	return &this
}
...
func (o SingleMoneyTransferRecipientData) MarshalJSON() ([]byte, error) {
...
type NullableSingleMoneyTransferRecipientData struct {
	value *SingleMoneyTransferRecipientData
	isSet bool
}

func (v NullableSingleMoneyTransferRecipientData) Get() *SingleMoneyTransferRecipientData {
	return v.value
}

func (v *NullableSingleMoneyTransferRecipientData) Set(val *SingleMoneyTransferRecipientData) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleMoneyTransferRecipientData) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleMoneyTransferRecipientData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleMoneyTransferRecipientData(val *SingleMoneyTransferRecipientData) *NullableSingleMoneyTransferRecipientData {
	return &NullableSingleMoneyTransferRecipientData{value: val, isSet: true}
}

func (v NullableSingleMoneyTransferRecipientData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleMoneyTransferRecipientData) UnmarshalJSON(src []byte) error {
	v.isSet = true
