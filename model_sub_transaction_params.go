...
func (o SubTransactionParams) MarshalJSON() ([]byte, error) {
...
type NullableSubTransactionParams struct {
	value *SubTransactionParams
	isSet bool
}

func (v NullableSubTransactionParams) Get() *SubTransactionParams {
	return v.value
}

func (v *NullableSubTransactionParams) Set(val *SubTransactionParams) {
	v.value = val
	v.isSet = true
}

func (v NullableSubTransactionParams) IsSet() bool {
	return v.isSet
}

func (v *NullableSubTransactionParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubTransactionParams(val *SubTransactionParams) *NullableSubTransactionParams {
	return &NullableSubTransactionParams{value: val, isSet: true}
}

func (v NullableSubTransactionParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubTransactionParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
