...
func (o TppAuthenticationGroup) MarshalJSON() ([]byte, error) {
...
type NullableTppAuthenticationGroup struct {
	value *TppAuthenticationGroup
	isSet bool
}

func (v NullableTppAuthenticationGroup) Get() *TppAuthenticationGroup {
	return v.value
}

func (v *NullableTppAuthenticationGroup) Set(val *TppAuthenticationGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableTppAuthenticationGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableTppAuthenticationGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTppAuthenticationGroup(val *TppAuthenticationGroup) *NullableTppAuthenticationGroup {
	return &NullableTppAuthenticationGroup{value: val, isSet: true}
}

func (v NullableTppAuthenticationGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTppAuthenticationGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
