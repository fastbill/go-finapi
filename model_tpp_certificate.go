...
type TppCertificate struct {
	...
	CertificateType TppCertificateType `json:"certificateType"`
...
func (o TppCertificate) MarshalJSON() ([]byte, error) {
...
type NullableTppCertificate struct {
	value *TppCertificate
	isSet bool
}

func (v NullableTppCertificate) Get() *TppCertificate {
	return v.value
}

func (v *NullableTppCertificate) Set(val *TppCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableTppCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableTppCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTppCertificate(val *TppCertificate) *NullableTppCertificate {
	return &NullableTppCertificate{value: val, isSet: true}
}

func (v NullableTppCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTppCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
