...
type TppCredentials struct {
	...
	ValidUntil NullableString `json:"validUntil"`
}
...
func (o TppCredentials) MarshalJSON() ([]byte, error) {
...
type NullableTppCredentials struct {
	value *TppCredentials
	isSet bool
}

func (v NullableTppCredentials) Get() *TppCredentials {
	return v.value
}

func (v *NullableTppCredentials) Set(val *TppCredentials) {
	v.value = val
	v.isSet = true
}

func (v NullableTppCredentials) IsSet() bool {
	return v.isSet
}

func (v *NullableTppCredentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTppCredentials(val *TppCredentials) *NullableTppCredentials {
	return &NullableTppCredentials{value: val, isSet: true}
}

func (v NullableTppCredentials) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTppCredentials) UnmarshalJSON(src []byte) error {
	v.isSet = true
