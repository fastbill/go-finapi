...
// GetTppAuthenticationGroupId returns the TppAuthenticationGroupId field value
...
// GetTppAuthenticationGroupIdOk returns a tuple with the TppAuthenticationGroupId field value
...
// SetTppAuthenticationGroupId sets field value
...
func (o TppCredentialsParams) MarshalJSON() ([]byte, error) {
...
type NullableTppCredentialsParams struct {
	value *TppCredentialsParams
	isSet bool
}

func (v NullableTppCredentialsParams) Get() *TppCredentialsParams {
	return v.value
}

func (v *NullableTppCredentialsParams) Set(val *TppCredentialsParams) {
	v.value = val
	v.isSet = true
}

func (v NullableTppCredentialsParams) IsSet() bool {
	return v.isSet
}

func (v *NullableTppCredentialsParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTppCredentialsParams(val *TppCredentialsParams) *NullableTppCredentialsParams {
	return &NullableTppCredentialsParams{value: val, isSet: true}
}

func (v NullableTppCredentialsParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTppCredentialsParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
