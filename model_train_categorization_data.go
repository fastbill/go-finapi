...
func (o *TrainCategorizationData) GetTransactionData() []TrainCategorizationTransactionData {
	if o == nil  {
		var ret []TrainCategorizationTransactionData
		return ret
	}
...
func (o TrainCategorizationData) MarshalJSON() ([]byte, error) {
...
type NullableTrainCategorizationData struct {
	value *TrainCategorizationData
	isSet bool
}

func (v NullableTrainCategorizationData) Get() *TrainCategorizationData {
	return v.value
}

func (v *NullableTrainCategorizationData) Set(val *TrainCategorizationData) {
	v.value = val
	v.isSet = true
}

func (v NullableTrainCategorizationData) IsSet() bool {
	return v.isSet
}

func (v *NullableTrainCategorizationData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrainCategorizationData(val *TrainCategorizationData) *NullableTrainCategorizationData {
	return &NullableTrainCategorizationData{value: val, isSet: true}
}

func (v NullableTrainCategorizationData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrainCategorizationData) UnmarshalJSON(src []byte) error {
	v.isSet = true
