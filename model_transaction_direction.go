...
const (
	TRANSACTIONDIRECTION_INCOME TransactionDirection = "Income"
	TRANSACTIONDIRECTION_SPENDING TransactionDirection = "Spending"
)
...
func (v *TransactionDirection) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []TransactionDirection{ "Income", "Spending",   } {
