...
type TwoStepProcedure struct {
	...
	ProcedureChallengeType NullableString `json:"procedureChallengeType"`
...
// GetProcedureName returns the ProcedureName field value
func (o *TwoStepProcedure) GetProcedureName() string {
	...
	return o.ProcedureName
}

// GetProcedureNameOk returns a tuple with the ProcedureName field value
// and a boolean to check if the value has been set.
func (o *TwoStepProcedure) GetProcedureNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ProcedureName, true
}

// SetProcedureName sets field value
func (o *TwoStepProcedure) SetProcedureName(v string) {
	o.ProcedureName = v
}

// GetProcedureChallengeType returns the ProcedureChallengeType field value
// If the value is explicit nil, the zero value for string will be returned
func (o *TwoStepProcedure) GetProcedureChallengeType() string {
	if o == nil || o.ProcedureChallengeType.Get() == nil {
		var ret string
		return ret
	}

	return *o.ProcedureChallengeType.Get()
}

// GetProcedureChallengeTypeOk returns a tuple with the ProcedureChallengeType field value
// and a boolean to check if the value has been set.
...
func (o *TwoStepProcedure) GetProcedureChallengeTypeOk() (*string, bool) {
	...
	return o.ProcedureChallengeType.Get(), o.ProcedureChallengeType.IsSet()
}

// SetProcedureChallengeType sets field value
func (o *TwoStepProcedure) SetProcedureChallengeType(v string) {
	o.ProcedureChallengeType.Set(&v)
}

// GetImplicitExecute returns the ImplicitExecute field value
func (o *TwoStepProcedure) GetImplicitExecute() bool {
	...
	return o.ImplicitExecute
}

// GetImplicitExecuteOk returns a tuple with the ImplicitExecute field value
// and a boolean to check if the value has been set.
func (o *TwoStepProcedure) GetImplicitExecuteOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ImplicitExecute, true
}

// SetImplicitExecute sets field value
func (o *TwoStepProcedure) SetImplicitExecute(v bool) {
	o.ImplicitExecute = v
}

func (o TwoStepProcedure) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["procedureId"] = o.ProcedureId
	}
	if true {
		toSerialize["procedureName"] = o.ProcedureName
	}
	if true {
		toSerialize["procedureChallengeType"] = o.ProcedureChallengeType.Get()
	}
	if true {
		toSerialize["implicitExecute"] = o.ImplicitExecute
	}
	return json.Marshal(toSerialize)
}

type NullableTwoStepProcedure struct {
	value *TwoStepProcedure
	isSet bool
}

func (v NullableTwoStepProcedure) Get() *TwoStepProcedure {
	return v.value
}

func (v *NullableTwoStepProcedure) Set(val *TwoStepProcedure) {
	v.value = val
	v.isSet = true
}

func (v NullableTwoStepProcedure) IsSet() bool {
	return v.isSet
}

func (v *NullableTwoStepProcedure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTwoStepProcedure(val *TwoStepProcedure) *NullableTwoStepProcedure {
	return &NullableTwoStepProcedure{value: val, isSet: true}
}

func (v NullableTwoStepProcedure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTwoStepProcedure) UnmarshalJSON(src []byte) error {
	v.isSet = true
