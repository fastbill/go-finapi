...
type UpdateMultipleTransactionsParams struct {
...
func NewUpdateMultipleTransactionsParams() *UpdateMultipleTransactionsParams {
	this := UpdateMultipleTransactionsParams{}
...
func (o UpdateMultipleTransactionsParams) MarshalJSON() ([]byte, error) {
...
type NullableUpdateMultipleTransactionsParams struct {
	value *UpdateMultipleTransactionsParams
	isSet bool
}

func (v NullableUpdateMultipleTransactionsParams) Get() *UpdateMultipleTransactionsParams {
	return v.value
}

func (v *NullableUpdateMultipleTransactionsParams) Set(val *UpdateMultipleTransactionsParams) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateMultipleTransactionsParams) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateMultipleTransactionsParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateMultipleTransactionsParams(val *UpdateMultipleTransactionsParams) *NullableUpdateMultipleTransactionsParams {
	return &NullableUpdateMultipleTransactionsParams{value: val, isSet: true}
}

func (v NullableUpdateMultipleTransactionsParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateMultipleTransactionsParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
