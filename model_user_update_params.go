...
func (o UserUpdateParams) MarshalJSON() ([]byte, error) {
...
type NullableUserUpdateParams struct {
	value *UserUpdateParams
	isSet bool
}

func (v NullableUserUpdateParams) Get() *UserUpdateParams {
	return v.value
}

func (v *NullableUserUpdateParams) Set(val *UserUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableUserUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableUserUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserUpdateParams(val *UserUpdateParams) *NullableUserUpdateParams {
	return &NullableUserUpdateParams{value: val, isSet: true}
}

func (v NullableUserUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
